...
h1 {color:blue;}p{color:red;}
    ...
    /**
     * In this test style tags can not be locked in a PH tag because there is not a closing </style> tag. It will be expressed as plain encode
     */
    ...
    /**
     * This should be treated as simple tags with no special meaning
     */
