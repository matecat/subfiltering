...
class MateCatFilterTest extends TestCase
{
    ...
    public function testFromLayer0ToLayer1WithNoHandlers()
    {
        ...
        $segmentL1 = $filter->fromLayer0ToLayer1($string);
        $this->assertEquals(
            'Text with <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_SELF_CLOSE_PH_WITH_EQUIV_TEXT . '" x-orig="PHBoIGlkPSIxIiBlcXVpdi10ZXh0PSImbHQ7YnIvJmd0OyIvPg==" equiv-text="base64:Jmx0O2JyLyZndDs="/> and placeholders &lt;b&gt;.',
            $segmentL1
        );
    }
    ...
    public function testICUString()
    {
        ...
        $filter = MateCatFilter::getInstance(
            ...
            'it-IT',
            null,
            [InjectableFiltersTags::single_curly, InjectableFiltersTags::markup, InjectableFiltersTags::sprintf]
        );
        ...
        $this->assertEquals(
            'You have {NUM_RESULTS, plural, =0 {no results} one {1 result} other {# results}} for "<ph id="mtc_1" ctype="' . CTypeEnum::CURLY_BRACKETS . '" equiv-text="base64:e1NFQVJDSF9URVJNfQ=="/>".',
            $segmentL1
        );
    ...
    public function testSmartCounts()
    {
        ...
        $this->assertEquals(
            'Test<ph id="mtc_1" ctype="' . CTypeEnum::SMART_COUNT . '" equiv-text="base64:fHx8fA=="/>and <ph id="mtc_2" ctype="x-smart-count" equiv-text="base64:fHx8fA=="/> fine.',
            $transformed
        );
