...
class MateCatFilterTest extends TestCase
{
    ...
    public function testFromLayer0ToLayer1WithNoHandlers()
    {
        ...
        $segmentL1 = $filter->fromLayer0ToLayer1($string);
        $this->assertEquals(
            'Text with <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_SELF_CLOSE_PH_WITH_EQUIV_TEXT->value . '" x-orig="PHBoIGlkPSIxIiBlcXVpdi10ZXh0PSImbHQ7YnIvJmd0OyIvPg==" equiv-text="base64:Jmx0O2JyLyZndDs="/> and placeholders &lt;b&gt;.',
            $segmentL1
        );
    }
    ...
    public function testICUString()
    {
        ...
        $filter = MateCatFilter::getInstance(
            ...
            'it-IT',
            null,
            [InjectableFiltersTags::single_curly->value, InjectableFiltersTags::markup->value, InjectableFiltersTags::sprintf->value]
        );
        ...
        $this->assertEquals(
            'You have {NUM_RESULTS, plural, =0 {no results} one {1 result} other {# results}} for "<ph id="mtc_1" ctype="' . CTypeEnum::CURLY_BRACKETS->value . '" equiv-text="base64:e1NFQVJDSF9URVJNfQ=="/>".',
            $segmentL1
        );
     ...
     * @return array
     */
    public static function fromLayer0ToRawXliffProvider(): array
    {
        return [
            'no tags or special characters' => [
                'layer0_segment' => 'This is a simple sentence.',
                'expected_raw_xliff' => 'This is a simple sentence.',
            ],
            'with stray < and > characters' => [
                'layer0_segment' => 'A > B and C < D.',
                'expected_raw_xliff' => 'A &gt; B and C &lt; D.',
            ],
            'with a g-tag and stray characters' => [
                'layer0_segment' => 'This is a <g id="1">g-tag</g>, and this is a stray < char.',
                'expected_raw_xliff' => 'This is a &lt;g id="1"&gt;g-tag&lt;/g&gt;, and this is a stray &lt; char.',
            ],
            'with already encoded HTML' => [
                'layer0_segment' => 'This is &lt;b&gt;bold&lt;/b&gt; text.',
                'expected_raw_xliff' => 'This is &lt;b&gt;bold&lt;/b&gt; text.', // Should not be double-encoded
            ],
            'with dangerous control characters' => [
                'layer0_segment' => "This is a dangerous char: \x07 and a valid <g id='1'>tag</g>.",
                'expected_raw_xliff' => "This is a dangerous char:  and a valid &lt;g id='1'&gt;tag&lt;/g&gt;.",
                // The BEL char should be removed
            ],
        ];
    }
    ...
    public function testComplexUrls()
    {
        ...
        $fromUi = '<ph id="mtc_14" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0O2EgaHJlZj0iaHR0cHM6Ly9hdXRoLnViZXIuY29tL2xvZ2luLz9icmVlemVfbG9jYWxfem9uZT1kY2ExJmFtcDthbXA7bmV4dF91cmw9aHR0cHMlM0ElMkYlMkZkcml2ZXJzLnViZXIuY29tJTJGcDMlMkYmYW1wO2FtcDtzdGF0ZT00MElLeF9YR0N1OXRobEtrSUkxUmRCOFlhUVRVY0g1aE1uVnllWXJCN0lBJTNEIiZndDs="/>Partner Dashboard<ph id="mtc_15" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0Oy9hJmd0Ow=="/> to match the payment document you uploaded';
    ...
    public function testComplexXML()
    {
        ...
        $string_from_UI = '<ph id="mtc_1" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0O3AmZ3Q7"/> Airbnb &amp;amp; Co. &amp;amp; <ph id="mtc_2" ctype="' . CTypeEnum::ORIGINAL_SELF_CLOSE_PH_WITH_EQUIV_TEXT->value . '" x-orig="PHBoIGlkPSJQbGFjZUhvbGRlcjEiIGVxdWl2LXRleHQ9InswfSIvPg==" equiv-text="base64:ezB9"/> &amp;quot; &amp;apos;<ph id="mtc_3" ctype="' . CTypeEnum::ORIGINAL_SELF_CLOSE_PH_WITH_EQUIV_TEXT->value . '" x-orig="PHBoIGlkPSJQbGFjZUhvbGRlcjIiIGVxdWl2LXRleHQ9Ii91c2Vycy9zZXR0aW5ncz90ZXN0PTEyMyZhbXA7Y2ljY2lvPTEiLz4=" equiv-text="base64:L3VzZXJzL3NldHRpbmdzP3Rlc3Q9MTIzJmFtcDtjaWNjaW89MQ=="/> <ph id="mtc_4" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0O2EgaHJlZj0iL3VzZXJzL3NldHRpbmdzP3Rlc3Q9MTIzJmFtcDthbXA7Y2ljY2lvPTEiIHRhcmdldD0iX2JsYW5rIiZndDs="/>';
    ...
    public function testOriginalPhContent()
    {
        ...
        $string_from_UI = 'Test <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_PH_CONTENT->value . '" x-orig="PHBoIGlkPSJQbGFjZUhvbGRlcjEiPkFpcmJuYiAmYW1wO2FtcDsgQ28uICZhbXA7YW1wOzwvcGg+" equiv-text="base64:QWlyYm5iICZhbXA7YW1wO2FtcDsgQ28uICZhbXA7YW1wO2FtcDs="/> locked.';
...
//is &lt; 70 dB(A).';
    ...
    public function test_3_HandlingNBSP()
    {
        ...
        $segment_to_UI = $string_from_UI = '5 tips for creating a great ' . ConstantEnum::nbspPlaceholder->value . ' guide';
    ...
    public function testHTMLFromLayer2()
    {
        ...
        //Start test
        $string_from_UI = '&lt;b&gt;de <ph id="mtc_1" ctype="' . CTypeEnum::SPRINTF->value . '" equiv-text="base64:JTEkcw=="/>, &lt;/b&gt;que';
        $this->assertEquals($expected_segment, $filter->fromLayer2ToLayer0($string_from_UI));

        $string_in_layer1 = '<ph id="mtc_1" ctype="' . CTypeEnum::XML->value . '" equiv-text="base64:Jmx0O2ImZ3Q7"/>de <ph id="mtc_2" ctype="' . CTypeEnum::SPRINTF->value . '" equiv-text="base64:JTEkcw=="/>, <ph id="mtc_3" ctype="' . CTypeEnum::XML->value . '" equiv-text="base64:Jmx0Oy9iJmd0Ow=="/>que';
    ...
    public function testNbsp()
    {
        ...
        $string_from_UI = ConstantEnum::nbspPlaceholder->value . ConstantEnum::nbspPlaceholder->value . ConstantEnum::nbspPlaceholder->value . 'Test';
    ...
    public function testNbspAsString()
    {
        ...
        $string_from_UI = '<ph id="mtc_1" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0Oy9hJmd0Ow=="/> - &amp;lt;/i&amp;gt; - &amp;nbsp; - ##$_A0$##    Text <g id="1">pippo</g>';
    ...
    public function testXliffTagsInsideAXliffFile()
    {
        ...
        $xliffTags = [
            [
                'db_segment' => '&lt;g id="1"&gt;',
                'expected_l1_segment' => '<ph id="mtc_1" ctype="' . CTypeEnum::XML->value . '" equiv-text="base64:Jmx0O2cgaWQ9IjEiJmd0Ow=="/>',
            ],
            [
                'db_segment' => '&lt;x id="1"/&gt;',
                'expected_l1_segment' => '<ph id="mtc_1" ctype="' . CTypeEnum::XML->value . '" equiv-text="base64:Jmx0O3ggaWQ9IjEiLyZndDs="/>',
            ],
            [
                'db_segment' => '&lt;pc id="1"&gt;',
                'expected_l1_segment' => '<ph id="mtc_1" ctype="' . CTypeEnum::XML->value . '" equiv-text="base64:Jmx0O3BjIGlkPSIxIiZndDs="/>',
            ],
        ];
    ...
    public function testTwigFilterWithSingleBrackets()
    {
        ...
        $expected = 'Hi {this strings would not be escaped}. Instead <ph id="mtc_1" ctype="' . CTypeEnum::TWIG->value . '" equiv-text="base64:e3t0aGlzIG9uZX19"/> is a valid twig expression. Also <ph id="mtc_2" ctype="' . CTypeEnum::TWIG->value . '" equiv-text="base64:eyVjaWFvJX0="/> is valid!';
    ...
    public function testTwigUngreedy()
    {
        ...
        $expected = 'Dear <ph id="mtc_1" ctype="' . CTypeEnum::TWIG->value . '" equiv-text="base64:e3tjdXN0b21lci5maXJzdF9uYW1lfX0="/>, This is <ph id="mtc_2" ctype="' . CTypeEnum::TWIG->value . '" equiv-text="base64:e3thZ2VudC5hbGlhc319"/> with Airbnb.';
    ...
    public function testPhWithoutDataRef()
    {
        ...
        // Persistance test
        $from_UI = 'Saame nähtavuse piirangutega kontrollida, <ph id="mtc_1" ctype="' . CTypeEnum::SPRINTF->value . '" equiv-text="base64:JXM="/> kes sisu näeb .<ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_PH_OR_NOT_DATA_REF->value . '" equiv-text="base64:PHBoIGlkPSJzb3VyY2UxIiBkYXRhUmVmPSJzb3VyY2UxIi8+"/>';
    ...
    public function testPHPlaceholderWithDataRef()
    {
        ...
        $expected_l2_segment = 'Frase semplice: <ph id="source1" ctype="' . CTypeEnum::PH_DATA_REF->value . '" equiv-text="base64:Jmx0O2JyJmd0Ow==" x-orig="PHBoIGlkPSJzb3VyY2UxIiBkYXRhUmVmPSJzb3VyY2UxIi8+"/>.';
        $expected_l2_translation = 'Simple sentence: <ph id="source1" ctype="' . CTypeEnum::PH_DATA_REF->value . '" equiv-text="base64:Jmx0O2JyJmd0Ow==" x-orig="PHBoIGlkPSJzb3VyY2UxIiBkYXRhUmVmPSJzb3VyY2UxIi8+"/>.';
    ...
    public function testWithTwoPCTagsWithLessThanBetweenThem()
    {
        ...
        $expected_l2_segment = '<ph id="source1_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGJyPg==" x-orig="PHBjIGlkPSJzb3VyY2UxIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTEiPg=="/>&lt;<ph id="source2_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGhyPg==" x-orig="PHBjIGlkPSJzb3VyY2UyIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTIiPg=="/>Rider /&gt;<ph id="source2_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGhyPg==" x-orig="PC9wYz4="/><ph id="source1_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGJyPg==" x-orig="PC9wYz4="/>';
    ...
    public function testPCWithComplexDataRefMap()
    {
        ...
        $expected_l2_segment = '<ph id="source1_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9ImxwdXhuaVFsSVczS3JVeXciIGN0eXBlPSJ4LWh0bWwtcCIgXC8+" x-orig="PHBjIGlkPSJzb3VyY2UxIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTEiPg=="/>Click the image on the left, read the information and then select the contact type that would replace the red question mark.<ph id="source1_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9ImxwdXhuaVFsSVczS3JVeXciIGN0eXBlPSJ4LWh0bWwtcCIgXC8+" x-orig="PC9wYz4="/><ph id="source2_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9ImQzVGxQdG9tbFV0MEVqMWsiIGN0eXBlPSJ4LWh0bWwtcCIgXC8+" x-orig="PHBjIGlkPSJzb3VyY2UyIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTIiPg=="/><ph id="source3_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9ImpjUC1URkZTTzJDU3N1THQiIGN0eXBlPSJ4LWh0bWwtc3Ryb25nIiBcLz4=" x-orig="PHBjIGlkPSJzb3VyY2UzIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTMiPg=="/>Things to consider:<ph id="source3_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9ImpjUC1URkZTTzJDU3N1THQiIGN0eXBlPSJ4LWh0bWwtc3Ryb25nIiBcLz4=" x-orig="PC9wYz4="/><ph id="source2_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9ImQzVGxQdG9tbFV0MEVqMWsiIGN0eXBlPSJ4LWh0bWwtcCIgXC8+" x-orig="PC9wYz4="/><ph id="source4_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9IjVTdENZWVJ2cU1jMFVBejQiIGN0eXBlPSJ4LWh0bWwtdWwiIFwvPg==" x-orig="PHBjIGlkPSJzb3VyY2U0IiBkYXRhUmVmU3RhcnQ9InNvdXJjZTQiPg=="/><ph id="source5_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9Ijk5cGhoSmNFUURMSEJqZVUiIGN0eXBlPSJ4LWh0bWwtbGkiIFwvPg==" x-orig="PHBjIGlkPSJzb3VyY2U1IiBkYXRhUmVmU3RhcnQ9InNvdXJjZTUiPg=="/>The rider stated the car had a different tag from another state.<ph id="source5_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9Ijk5cGhoSmNFUURMSEJqZVUiIGN0eXBlPSJ4LWh0bWwtbGkiIFwvPg==" x-orig="PC9wYz4="/><ph id="source6_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9IjBIWnVnMWQzTGtYSlUwNEUiIGN0eXBlPSJ4LWh0bWwtbGkiIFwvPg==" x-orig="PHBjIGlkPSJzb3VyY2U2IiBkYXRhUmVmU3RhcnQ9InNvdXJjZTYiPg=="/>The rider stated the car had a color from the one registered in Bliss.<ph id="source6_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9IjBIWnVnMWQzTGtYSlUwNEUiIGN0eXBlPSJ4LWh0bWwtbGkiIFwvPg==" x-orig="PC9wYz4="/><ph id="source7_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9Im9aM29XXzBLYWljRlhGRFMiIGN0eXBlPSJ4LWh0bWwtbGkiIFwvPg==" x-orig="PHBjIGlkPSJzb3VyY2U3IiBkYXRhUmVmU3RhcnQ9InNvdXJjZTciPg=="/>The rider can’t tell if the driver matched the profile picture.<ph id="source7_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9Im9aM29XXzBLYWljRlhGRFMiIGN0eXBlPSJ4LWh0bWwtbGkiIFwvPg==" x-orig="PC9wYz4="/><ph id="source4_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:PGcgaWQ9IjVTdENZWVJ2cU1jMFVBejQiIGN0eXBlPSJ4LWh0bWwtdWwiIFwvPg==" x-orig="PC9wYz4="/>';
    ...
    public function testPCWithoutAnyDataRefMap()
    {
        ...
        $expected_l2_segment = 'Practice using <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_PC_OPEN_NO_DATA_REF->value . '" equiv-text="base64:PHBjIGlkPSIxYiIgdHlwZT0iZm10IiBzdWJUeXBlPSJtOmIiPg=="/>coaching frameworks<ph id="mtc_2" ctype="' . CTypeEnum::ORIGINAL_PC_CLOSE_NO_DATA_REF->value . '" equiv-text="base64:PC9wYz4="/> and skills with peers and coaches in a safe learning environment.';
    ...
    public function testMostSimpleCaseOfPC()
    {
        ...
        $expected_l2_segment = 'Testo libero contenente <ph id="1_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:Xw==" x-orig="PHBjIGlkPSIxIiBjYW5Db3B5PSJubyIgY2FuRGVsZXRlPSJubyIgZGF0YVJlZkVuZD0iZDEiIGRhdGFSZWZTdGFydD0iZDEiPg=="/>corsivo<ph id="1_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:Xw==" x-orig="PC9wYz4="/>.';
    ...
    public function testDoublePCPlaceholderWithDataRef()
    {
        ...
        $expected_l2_segment = 'Link semplice: <ph id="1_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:Ww==" x-orig="PHBjIGlkPSIxIiBjYW5Db3B5PSJubyIgY2FuRGVsZXRlPSJubyIgZGF0YVJlZkVuZD0iZDIiIGRhdGFSZWZTdGFydD0iZDEiPg=="/>La Repubblica<ph id="1_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:XShodHRwOi8vcmVwdWJibGljYS5pdCk=" x-orig="PC9wYz4="/>.';
    ...
    public function testWithPCTagsWithAndWithoutDataRefInTheSameSegment()
    {
        ...
        $expected_l2_segment = 'Text <ph id="source1_1" ctype="' . CTypeEnum::PC_OPEN_DATA_REF->value . '" equiv-text="base64:eA==" x-orig="PHBjIGlkPSJzb3VyY2UxIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTEiIGRhdGFSZWZFbmQ9InNvdXJjZTEiPg=="/><ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_PC_OPEN_NO_DATA_REF->value . '" equiv-text="base64:PHBjIGlkPSIxdSIgdHlwZT0iZm10IiBzdWJUeXBlPSJtOnUiPg=="/>link<ph id="mtc_2" ctype="' . CTypeEnum::ORIGINAL_PC_CLOSE_NO_DATA_REF->value . '" equiv-text="base64:PC9wYz4="/><ph id="source1_2" ctype="' . CTypeEnum::PC_CLOSE_DATA_REF->value . '" equiv-text="base64:eA==" x-orig="PC9wYz4="/>.';
...
//        $expected_l2_segment = '&lt;ph id="mtc_1" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:Jmx0O3NwYW4gZGF0YS10eXBlPSJob3RzcG90IiBjbGFzcz0iaG90c3BvdE9uSW1hZ2UiIHN0eWxlPSJwb3NpdGlvbjogcmVsYXRpdmU7ZGlzcGxheTogaW5saW5lLWJsb2NrO21heC13aWR0aDogMTAwJSImZ3Q7"/&gt;&lt;ph id="mtc_2" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:Jmx0O2ltZyBzcmM9Imh0dHBzOi8vZmlsZXMtc3RvcmFnZS5lYXN5Z2VuZXJhdG9yLmNvbS9pbWFnZS9hNTljYzcwMi1iNjA5LTQ4M2QtODliZC1kNjUwODRjZGUwZWQucG5nIiBhbHQ9IiIgc3R5bGU9Im1heC13aWR0aDoxMDAlIiZndDs="/&gt;&lt;ph id="mtc_3" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:"/&gt;&lt;ph id="mtc_4" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:Jmx0Oy9zcGFuJmd0Ow=="/&gt;&lt;ph id="mtc_5" equiv-text="base64:"/&gt;&lt;ph id="mtc_6" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:Jmx0Oy9zcGFuJmd0Ow=="/&gt;&lt;ph id="mtc_7" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:"/&gt;&lt;ph id="mtc_8" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:Jmx0Oy9zcGFuJmd0Ow=="/&gt;&lt;ph id="mtc_9" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:"/&gt;&lt;ph id="mtc_10" ctype="'.CTypeEnum::XML.'"->value equiv-text="base64:Jmx0Oy9zcGFuJmd0Ow=="/&gt;&lt;ph id="mtc_11" equiv-text="base64:Jmx0Oy9zcGFuJmd0Ow=="/&gt;';
        ...
        $expected_l1_segment = '<ph id="mtc_1" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0O3NwYW4gZGF0YS10eXBlPSJob3RzcG90IiBjbGFzcz0iaG90c3BvdE9uSW1hZ2UiIHN0eWxlPSJwb3NpdGlvbjogcmVsYXRpdmU7ZGlzcGxheTogaW5saW5lLWJsb2NrO21heC13aWR0aDogMTAwJSImZ3Q7"/>';
        $expected_l2_segment = '<ph id="mtc_1" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0O3NwYW4gZGF0YS10eXBlPSJob3RzcG90IiBjbGFzcz0iaG90c3BvdE9uSW1hZ2UiIHN0eWxlPSJwb3NpdGlvbjogcmVsYXRpdmU7ZGlzcGxheTogaW5saW5lLWJsb2NrO21heC13aWR0aDogMTAwJSImZ3Q7"/>';
    ...
    public function testPhTagsWithoutDataRef()
    {
        ...
        $expected_l2_segment = '<ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_PH_OR_NOT_DATA_REF->value . '" equiv-text="base64:PHBoIGlkPSIxaiIgdHlwZT0ib3RoZXIiIHN1YlR5cGU9Im06aiIvPg=="/>';
...
//    }
    ...
    public function testXliffInXliffWithoutId()
    {
        ...
        $layer1And2 = 'Test <ph id="mtc_1" ctype="' . CTypeEnum::XML->value . '" equiv-text="base64:Jmx0O1gmZ3Q7"/> and <ph id="mtc_2" ctype="' . CTypeEnum::XML->value . '" equiv-text="base64:Jmx0Oy9YJmd0Ow=="/> fine.';
    ...
    public function testSmartCounts()
    {
        ...
        $this->assertEquals(
            'Test<ph id="mtc_1" ctype="' . CTypeEnum::SMART_COUNT->value . '" equiv-text="base64:fHx8fA=="/>and <ph id="mtc_2" ctype="x-smart-count" equiv-text="base64:fHx8fA=="/> fine.',
            $transformed
        );
    ...
    public function testHtmlDoubleEncodedInXML()
    {
        ...
        $expectedL1 = '<g id="123"><ph id="mtc_1" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0O2NvZGUmZ3Q7"/> &amp;lt;strong&amp;gt; THIS IS TREATED AS TEXT CONTENT EVEN IF IT IS AN HTML &amp;lt;/strong&amp;gt; <ph id="mtc_2" ctype="' . CTypeEnum::HTML->value . '" equiv-text="base64:Jmx0Oy9jb2RlJmd0Ow=="/></g>';
    ...
    public function testOriginalPhWithHtmlAttributes()
    {
        ...
        $string_from_UI = 'Test <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_SELF_CLOSE_PH_WITH_EQUIV_TEXT->value . '" x-orig="PHBoIGlkPSJQbGFjZUhvbGRlcjEiIGVxdWl2LXRleHQ9IiZsdDtwaCBpZD0mcXVvdDszJnF1b3Q7IGRpc3A9JnF1b3Q7e3tkYXRhfX0mcXVvdDsgZGF0YVJlZj0mcXVvdDtkMSZxdW90OyAvJmd0OyIvPg==" equiv-text="base64:Jmx0O3BoIGlkPSZxdW90OzMmcXVvdDsgZGlzcD0mcXVvdDt7e2RhdGF9fSZxdW90OyBkYXRhUmVmPSZxdW90O2QxJnF1b3Q7IC8mZ3Q7"/> locked.';
    ...
    public function testRealCaseMxliff()
    {
        ...
        $string_from_UI = 'For the site <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_PH_OR_NOT_DATA_REF->value . '" equiv-text="base64:PHBoIGlkPSI0IiBkaXNwPSJ7e3NpdGVJZH19IiBkYXRhUmVmPSJkMiIvPg=="/><ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjIiIGVxdWl2LXRleHQ9IiZsdDtwaCBpZD0mcXVvdDs0JnF1b3Q7IGRpc3A9JnF1b3Q7e3tzaXRlSWR9fSZxdW90OyBkYXRhUmVmPSZxdW90O2QyJnF1b3Q7IC8mZ3Q7Ii8+" equiv-text="base64:Jmx0O3BoIGlkPSZxdW90OzQmcXVvdDsgZGlzcD0mcXVvdDt7e3NpdGVJZH19JnF1b3Q7IGRhdGFSZWY9JnF1b3Q7ZDImcXVvdDsgLyZndDs="/><x id="3"/> group id <x id="4"/><x id="5"/><x id="6"/> is already associated.';
    ...
    public function testXtagAndXtagWithEquivText()
    {
        ...
        $string_from_UI = 'Click <x id="1"/>Create Site Admin<ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjIiIGVxdWl2LXRleHQ9ImJvbGQiLz4=" equiv-text="base64:Ym9sZA=="/><ph id="mtc_2" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjMiIGVxdWl2LXRleHQ9Iml0YWxpYyIvPg==" equiv-text="base64:aXRhbGlj"/>administration<ph id="mtc_3" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjQiIGVxdWl2LXRleHQ9Iml0YWxpYyIvPg==" equiv-text="base64:aXRhbGlj"/> site.';
    ...
    public function testXtagAndXtagWithEquivTextWithRandomAttributeOrder()
    {
        ...
        $string_from_UI = 'Click <x id="1"/>Create Site Admin<ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjIiIGVxdWl2LXRleHQ9ImJvbGQiLz4=" equiv-text="base64:Ym9sZA=="/><ph id="mtc_2" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggZXF1aXYtdGV4dD0iaXRhbGljIiBpZD0iMyIvPg==" equiv-text="base64:aXRhbGlj"/>administration<ph id="mtc_3" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggZXF1aXYtdGV4dD0iaXRhbGljIiB4LWF0dHJpYnV0ZT0icGlwcG8tYXR0cmlidXRlIiBpZD0iNCIvPg==" equiv-text="base64:aXRhbGlj"/> site.';
    ...
    public function testRandomPhAndXTags()
    {
        ...
        $string_from_UI = 'Click <x id="1"/>Create <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_SELF_CLOSE_PH_WITH_EQUIV_TEXT->value . '" x-orig="PHBoIGlkPSJQbGFjZUhvbGRlcjEiIGVxdWl2LXRleHQ9IiZsdDtwaCBpZD0mcXVvdDszJnF1b3Q7IGRpc3A9JnF1b3Q7e3tkYXRhfX0mcXVvdDsgZGF0YVJlZj0mcXVvdDtkMSZxdW90OyAvJmd0OyIvPg==" equiv-text="base64:Jmx0O3BoIGlkPSZxdW90OzMmcXVvdDsgZGlzcD0mcXVvdDt7e2RhdGF9fSZxdW90OyBkYXRhUmVmPSZxdW90O2QxJnF1b3Q7IC8mZ3Q7"/>Site Admin<ph id="mtc_2" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjIiIGVxdWl2LXRleHQ9ImJvbGQiLz4=" equiv-text="base64:Ym9sZA=="/><ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_PH_OR_NOT_DATA_REF->value . '" equiv-text="base64:PHBoIGlkPSIxMTEiLz4="/><ph id="mtc_3" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjMiIGVxdWl2LXRleHQ9Iml0YWxpYyIvPg==" equiv-text="base64:aXRhbGlj"/>administration<ph id="mtc_4" ctype="' . CTypeEnum::ORIGINAL_X->value . '" x-orig="PHggaWQ9IjQiIGVxdWl2LXRleHQ9Iml0YWxpYyIvPg==" equiv-text="base64:aXRhbGlj"/> site.';
    ...
    public function when_empty_equiv_text_shgould_put_NULL_in_converted_ph()
    {
        ...
        $expected = 'Hola <ph id="mtc_1" ctype="' . CTypeEnum::ORIGINAL_SELF_CLOSE_PH_WITH_EQUIV_TEXT->value . '" x-orig="PHBoIGlkPSJzb3VyY2UxIiBkYXRhUmVmPSJzb3VyY2UxIiBlcXVpdi10ZXh0PSIiLz4=" equiv-text="base64:TlVMTA=="/>';
