...
class MateCatCustomPHToStandardTag extends AbstractHandler {

    public function transform( $segment ) {

        //pipeline for restore PH tag of subfiltering to original encoded HTML
        preg_match_all( '|<ph id\s*=\s*["\']mtc_[0-9]+["\'] x-orig\s*=\s*["\']([^"\']+)["\'] equiv-text\s*=\s*["\']base64:[^"\']+["\']\s*/>|iU', $segment, $html, PREG_SET_ORDER ); // Ungreedy
